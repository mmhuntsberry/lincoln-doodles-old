...
export type RoleWhereInput = {
  ...
  readonly canManageOrderItems?: Scalars['Boolean'] | null;
  readonly canManageOrderItems_not?: Scalars['Boolean'] | null;
...
export type SortRolesBy =
  ...
  | 'canManageOrderItems_ASC'
  | 'canManageOrderItems_DESC'
  | 'assignedTo_ASC'
  | 'assignedTo_DESC';
...
export type OrderListTypeInfo = {
  key: 'Order';
  fields: 'id' | 'label' | 'date' | 'total' | 'items' | 'user' | 'charge';
  backing: {
    readonly id: string;
...
export type RoleListTypeInfo = {
  ...
  backing: {
    ...
    readonly canManageOrderItems?: boolean | null;
